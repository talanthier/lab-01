...
8. Consider the distribution of `class`. 
  ...
  Class appears to take the values 1,2, and 3, but we do have one missing observation in our filtered dataset. Looking at the description of the dataset from the MTC Open Data Catalog, they do not have anything indicating what the class variable means. Taking a guess, class could possibly indicate the quality of the trail (1 being low quality, 3 being high quality). It could also indicate something like how much traffic that segment of trail gets. If we were to interpret `class` this way, a missing value may indicate that they have yet to asses the quality of the trail segment or have not observed how much traffic the trail gets yet.
...
```{r eval=FALSE}
trails_filtered <- short_current_trails %>% filter(class !=3) %>% 
